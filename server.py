"""Simple HTTP Server.
This module builds on BaseHTTPServer by implementing the standard GET and HEAD requests.
It supports GZIP compression and api history callback, which is suitable to host a static
single page application using the HTML5 history API
"""
